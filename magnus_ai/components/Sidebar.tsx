...
import { MagnusIcon, ChatBubbleIcon, PlusIcon, UserIcon, TrashIcon, LogoutIcon, TrophyIcon, StarIcon, FireIcon } from './icons/Icons';
...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  onOpenSettingsModal, onOpenHelpModal, onOpenChallengeModal
}) => {
